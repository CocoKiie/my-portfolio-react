...
function ProjectDetails() {
  ...
  useEffect(() => {
    // Effectuez la requête pour obtenir les détails du projet en utilisant uniquement l'identifiant du projet
    fetch(`http://localhost/portfolio-react/portfolio/src/routes/project-detail.php?id=${projectId}`)
      .then(response => response.json())
      .then(data => {
        // Mettez à jour l'état avec les données du projet
        setProject(data);
